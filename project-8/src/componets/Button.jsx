  ...
  return (
    <>
      <div className='flex justify-center lg:justify-end mx-10 py-10'>
        <button
          onClick={handleClick}
          className='uppercase px-10 py-2 text-[#ececec] tracking-widest tranparent border-2 border-[#a5b0d0] rounded-lg '>
          rules
        </button>
      </div>
  ...
  return (
    <div className='flex flex-col items-center gap-10  fixed overflow-y-hidden top-0 w-screen h-screen bg-[#ffffff]'>
      ...
      <button
        ...
        className='focus:scale-[-1.4] transition duration-100'>
...
const DesktopModal = ({ desktopModal, setDesktopModal }) => {
  return (
    <div
      ...
      tabindex='-1'
      aria-hidden='true'
      class='fixed flex items-center justify-center top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full'>
      <div className='relative w-full h-full max-w-xl md:h-auto'>
        <div className='relative bg-[#f2f2f2] rounded-lg shadow '>
          ...
          <div className='p-8 space-y-6 flex justify-center'>
            <svg xmlns='http://www.w3.org/2000/svg' width='324' height='290'>
              <defs>
                <linearGradient id='a' x1='50%' x2='50%' y1='0%' y2='100%'>
                  <stop offset='0%' stop-color='#FFF' stop-opacity='.097' />
                  <stop offset='100%' stop-color='#FFF' stop-opacity='0' />
